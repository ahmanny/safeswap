        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {personas.map((persona, index) => (
            <AnimateOnScroll key={persona.title} delay={index * 0.1}>
              <div className="bg-white dark:bg-[#0D1B2E] rounded-2xl p-6 shadow-xs hover:shadow-md dark:hover:bg-[#132036] hover:scale-[1.02] transition-all duration-200 border border-gray-100 dark:border-white/10 flex flex-col justify-between h-full">
                <div>
