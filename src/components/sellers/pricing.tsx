    ...
    <section className="bg-[#F8FAFC] py-20 md:py-28 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 shadow-xl max-w-md mx-auto border border-gray-100 text-center"
        >
          <span className="text-sm font-bold text-gray-400 uppercase tracking-wider block mb-3">
            Seller Transaction Fee
          </span>

          <div className="text-6xl font-black text-[#0A2540] mb-1 tracking-tight">
            1.5%
          </div>
          <span className="text-gray-400 text-sm font-medium block mb-6">
            per transaction
          </span>

          {/* Included Features */}
          <div className="text-left space-y-3 mb-8 border-t border-b border-gray-100 py-6">
            {features.map((item) => (
          ...
          <div className="bg-[#F8FAFC] rounded-xl p-4 text-xs sm:text-sm text-gray-600 font-medium mb-4 border border-gray-100">
            Sell <span className="font-bold text-[#0A2540]">₦50,000</span> item → Fee: <span className="font-bold text-[#F59E0B]">₦750</span> <br />
